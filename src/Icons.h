...
// Коды иконок в формате Unicode
#define ICON_MIN_FA 0xf000
#define ICON_MAX_FA 0xf897

// Отдельные иконки (FontAwesome 6 Free)
#define ICON_FA_SAVE u8"\uf0c7"   // Значок сохранения
...
#define ICON_FA_FILE_TEXT u8"\uf00d" // лист с текстом
#define ICON_FA_FILE_ZIP u8"\uf1c6"  // лист с застежкой
#define ICON_FA_HANDS u8"\uf2b5"     // рукопожатие
#define ICON_FA_TIE u8"\uf27e"       // галстук
